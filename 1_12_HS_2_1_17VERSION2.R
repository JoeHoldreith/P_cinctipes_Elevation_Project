...
data=read.csv("1_12_HS_2_1_17.csv")
data=data[1:61,]
...
data$G1=as.integer(data$G1)
data$H1=as.integer(data$H1)
...
data_zeros = data[,c(51,63)]
data_zeros$mean = rowMeans(data_zeros[,1:2])
...
#remove bad control wells
data_corr_tall = filter(data_corr_tall, Well != "G1")
data_corr_tall = filter(data_corr_tall, Well != "H1")
...
Summarized_data$Mom[1:5] = "Higher Zone Winter 5"
Summarized_data$Mom[6:13] = "Higher Zone Winter 6"
Summarized_data$Mom[14:20] = "Higher Zone Winter 7"
Summarized_data$Mom[21:26] = "Higher Zone Winter 8"
Summarized_data$Mom[27:35] = "Lower Zone Winter 5"
Summarized_data$Mom[36:43] = "Lower Zone Winter 6"
Summarized_data$Mom[44:52] = "Lower Zone Winter 7"
Summarized_data$Mom[53:59] = "Lower Zone Winter 8"
Summarized_data$Mom_numeric[1:5] = 9
Summarized_data$Mom_numeric[6:13] = 10
Summarized_data$Mom_numeric[14:20] = 11
Summarized_data$Mom_numeric[21:26] = 12
Summarized_data$Mom_numeric[27:35] = 21
Summarized_data$Mom_numeric[36:43] = 22
Summarized_data$Mom_numeric[44:52] = 23
Summarized_data$Mom_numeric[53:59] = 24
Summarized_data$Elevation[1:26] = "Higher"
Summarized_data$Elevation[27:59] = "Lower"
Summarized_data$Treatment[1:59] = "Heat Shock"
Summarized_data$Day_of_Exp[1:59] = "6"
Summarized_data$Julien_Date[1:59] = "17"
Summarized_data$Coll_date[1:59] = "Winter"

write.csv(Summarized_data,"C:/Users/joemh/Desktop/Tecan CSV Files/QCd Resp Rates/1_12H2_1_17respiration_rates_QC_complete.CSV")
