...
data=read.csv("1_12_C1_1_18.csv")
data=data[1:61,]
...
Summarized_data = filter(Summarized_data, Well != "D4")
Summarized_data = filter(Summarized_data, Well != "G4")
Summarized_data = filter(Summarized_data, Well != "H6")

#trim wells with dead/hatched embryos
Summarized_data = filter(Summarized_data, Well != "F11")
...
Summarized_data$Mom[1:7] = "Higher Zone Winter 1"
Summarized_data$Mom[8:17] = "Higher Zone Winter 2"
Summarized_data$Mom[18:25] = "Higher Zone Winter 3"
Summarized_data$Mom[26:35] = "Higher Zone Winter 4"
Summarized_data$Mom[36:46] = "Lower Zone Winter 1"
Summarized_data$Mom[47:56] = "Lower Zone Winter 2"
Summarized_data$Mom[57:62] = "Lower Zone Winter 3"
Summarized_data$Mom[63:68]= "Lower Zone Winter 4"
Summarized_data$Mom_numeric[1:7] = 5
Summarized_data$Mom_numeric[8:17] = 6
Summarized_data$Mom_numeric[18:25] = 7
Summarized_data$Mom_numeric[26:35] = 8
Summarized_data$Mom_numeric[36:46] = 17
Summarized_data$Mom_numeric[47:56] = 18
Summarized_data$Mom_numeric[57:62] = 19
Summarized_data$Mom_numeric[63:68]= 20
Summarized_data$Elevation[1:35] = "Higher"
Summarized_data$Elevation[36:68] = "Lower"
Summarized_data$Treatment[1:68] = "Control"
Summarized_data$Day_of_Exp[1:68] = "7"
Summarized_data$Julien_Date[1:68] = "18"
Summarized_data$Coll_date[1:68] = "Winter"

write.csv(Summarized_data,"C:/Users/joemh/Desktop/Tecan CSV Files/QCd Resp Rates/1_12C1_1_18respiration_rates_QC_complete.CSV")
