...
data=read.csv("1_12_C2_1_19.csv")
data=data[1:61,]
...
ggplot(data_tall_blanks, aes(x=Time, y=value))+geom_point()+facet_wrap(~Well, scales = "free")+geom_smooth(method="lm") + xlab("Hours") + ylab("Fluoresence") + ggtitle("Oxygenated Controls")
ggplot(data_tall_zeros, aes(x=Time, y=value))+geom_point()+facet_wrap(~Well, scales = "free")+geom_smooth(method="lm") + xlab("Hours") + ylab("Fluoresence") +ggtitle("Deoxygenated Controls")
...
Summarized_data = filter(Summarized_data, Well != "B3")
Summarized_data = filter(Summarized_data, Well != "B4")
Summarized_data = filter(Summarized_data, Well != "D3")
Summarized_data = filter(Summarized_data, Well != "H10")
...
Summarized_data$Mom[1:11] = "Higher Zone Winter 5"
Summarized_data$Mom[12:16] = "Higher Zone Winter 6"
Summarized_data$Mom[17:27] = "Higher Zone Winter 7"
Summarized_data$Mom[28:35] = "Higher Zone Winter 8"
Summarized_data$Mom[36:46] = "Lower Zone Winter 5"
Summarized_data$Mom[47:57] = "Lower Zone Winter 6"
Summarized_data$Mom[58:67] = "Lower Zone Winter 7"
Summarized_data$Mom[68:77] = "Lower Zone Winter 8"
Summarized_data$Mom_numeric[1:11] = 9
Summarized_data$Mom_numeric[12:16] = 10
Summarized_data$Mom_numeric[17:27] = 11
Summarized_data$Mom_numeric[28:35] = 12
Summarized_data$Mom_numeric[36:46] = 21
Summarized_data$Mom_numeric[47:57] = 22
Summarized_data$Mom_numeric[58:67] = 23
Summarized_data$Mom_numeric[68:77] = 24
Summarized_data$Elevation[1:35] = "Higher"
Summarized_data$Elevation[36:77] = "Lower"
Summarized_data$Treatment[1:77] = "Control"
Summarized_data$Day_of_Exp[1:77] = "8"
Summarized_data$Julien_Date[1:77] = "19"
Summarized_data$Coll_date[1:77] = "Winter"

write.csv(Summarized_data,"C:/Users/joemh/Desktop/Tecan CSV Files/QCd Resp Rates/1_12C2_1_19respiration_rates_QC_complete.CSV")
